            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 18, 
                    color: Colors.grey[400], // Lighter grey for product type
                  ),
                ),
                const SizedBox(height: 4), // Space before collection time
                Text(
                  'Collect today: ${item['collectionTime']}',
                  style: TextStyle(
                    fontSize: 14,
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                        ...
                        color: Colors.grey[500], // Slightly lighter grey for original price
                      ),
                    ),
                    const SizedBox(width: 10), // Space between original and discounted price
                    Text(
